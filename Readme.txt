...
- It is necessary to create an input file Input.txt in the path C::\\Temp\\Input.txt;
- It is necessary to create an output file Output.txt in the path C::\\Temp\\Output.txt;
